...
class RenderStatic(RCTRender, bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for i in range(context.scene.rct_graphics_helper_general_properties.number_of_rider_sets + 1):
            self.renderTask.add(
                [[False, context.scene.rct_graphics_helper_static_properties.viewing_angles, 0, 0, 0]], i, False, 0,
                context.scene.rct_graphics_helper_general_properties.number_of_animation_frames,
                self.props.object_width, self.props.object_length)
